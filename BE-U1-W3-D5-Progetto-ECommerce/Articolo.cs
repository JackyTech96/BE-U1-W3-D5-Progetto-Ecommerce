...
namespace BE_U1_W3_D5_Progetto_ECommerce
{
    ...
    public static class DatabaseSimulato
    {
        private static List<Articolo> listaArticoli = new List<Articolo>
        {
            ...
            new Articolo { Id = 1, Nome = "Occhiale 1", Descrizione = "Occhiali da vista con montatura tigrata", Prezzo = 120.50m, ImmagineUrl = "https://images.unsplash.com/photo-1603578119639-798b8413d8d7?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
            new Articolo { Id = 2, Nome = "Occhiale 2", Descrizione = "Occhiali anti luce blu con montatura nera", Prezzo = 75, ImmagineUrl = "https://images.unsplash.com/photo-1483412468200-72182dbbc544?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
            new Articolo { Id = 3, Nome = "Occhiale 3", Descrizione = "Occhiali da vista con montatura nera", Prezzo = 199.95m, ImmagineUrl = "https://images.unsplash.com/photo-1619089661769-3101dbac9257?q=80&w=2028&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
            new Articolo { Id = 4, Nome = "Occhiale 4", Descrizione = "Occhiali da sole con montatura nera e lenti fluo", Prezzo = 250, ImmagineUrl = "https://images.unsplash.com/flagged/photo-1577479662097-5e0347cbe923?q=80&w=2076&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" }
        };
        ...
        public static Articolo GetDettagliProdotto(int productId)
        {
    ...
    public static class Carrello
    {
        ...
        {
            Articolo articoloDaRimuovere = articoliNelCarrello.FirstOrDefault(a => a.Id == articoloId);
